...
const RhplusVeBlood = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.transferred_aplus_wb_crc}?</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.transferred_bplus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.transferred_abplus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.transferred_oplus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.transferred_ffp_units}</p>;
      },
      sorter: false,
    },
  ];
