...
const RhMinusVeBlood = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.requested_aminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.requested_bminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.requested_abminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
    ...
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.distributed_aminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.distributed_bminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.distributed_abminus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      dataIndex: "target",
      render: (_, record) => {
        return <p>{record.distributed_ominus_wb_crc}</p>;
      },
      sorter: false,
    },
    {
      ...
      render: (_, record) => {
        return (
          <p>
            ...
            %{` (${record.distributed_bminus_wb_crc})`}
          </p>
        );
      },
      sorter: false,
      ...
      render: (_, record) => {
        return (
          <p>
            ...
            %{` (${record.distributed_abminus_wb_crc})`}
          </p>
        );
      },
      sorter: false,
      ...
      render: (_, record) => {
        return (
          <p>
            ...
            %{` (${record.distributed_ominus_wb_crc})`}
          </p>
        );
      },
      sorter: false,
      ...
      render: (_, record) => {
        return (
          <p>
            ...
            %{` (${record.distributed_platelets_units})`}
          </p>
        );
      },
      sorter: false,
