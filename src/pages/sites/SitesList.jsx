...
import { FiEdit } from 'react-icons/fi';
    ...
    async function searchData() {
        ...
        const handleReload = () => {
            ...
            dispatch(updateSitesState({ page: 1, limit: 5, sort: '', order: '', searchText: '' }))
            searchData();
        }
    ...
    const columns = [
             ...
             
            {
                ...
                render: (text, recored) => {
                    return <p>{recored?.coordinatorId.firstName + " " + recored?.coordinatorId.lastName}</p>
                },
                sorter: true,
    ...
    return (
            <div className=" max-w-[1200px] m-auto">

                {
                    ...
                    <SitesEdit sitesData={sitesData} searchData={searchData} setMode={setModeID} mode={modeID} isModelOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
                    </CommonModal> : ""
                }
