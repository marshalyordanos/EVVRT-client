...
export const searchUsers = createAsyncThunk(
    ...
    async (data, { rejectWithValue,getState }) => {
      try {
        ...
        const { searchText,page,limit,sort,order,role } = getState().users.query; // Access state directly

        const res = await UsersService.searchUser({page,limit,searchText,sort,order,role});
